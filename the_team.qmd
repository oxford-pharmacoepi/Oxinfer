...
OxInfer is part of the wider [Health Data Sciences section](https://www.ndorms.ox.ac.uk/research/research-groups/Musculoskeletal-Pharmacoepidemiology), based within the [Nuffield Department of Orthopaedics, Rheumatology and Musculoskeletal Sciences (NDORMS)](https://www.ndorms.ox.ac.uk), University of Oxford.
...
x <- dplyr::tibble(
  ndorms_id = c(
    ...
    "xihang-chen", "kim-lopez-guell", "marta-alcalde-herraiz",
    "nuria-mercade-besora", "elin-rowlands", "cecilia-campanile",
    "folu-akintola"
  ),
  github = c(
    "edward-burn", "catalamarti", "daniellenewby", "ilovemane", "xihang-chen",
    "KimLopezGuell", "martaalcalde", "nmercadeb", "elinrow", "cecicampanile",
    "Foluwa"
  ),
  email = c(
    "edarwd.burn@ndorms", "marti.catalasabate@ndorms", "danielle.newby@ndorms", 
    "mike.du@ndorms", "xihang.chen@ndorms", "kim.lopez@spc",
    "marta.alcaldeherraiz@ndorms", "nuria.mercadebesora@ndorms", 
    "elin.rowlands@ndorms", "cecilia.campanile@ndorms",
    "folu.akintola@ndorms.ox.ac.uk"
  ),
  twitter = "",
  linkedin = ""
)
...
for (k in seq_len(nrow(x))) {
  ...
  if (length(description) == 0) {
    ...
    # take last
    # addition of projects not differentiated
    description <- trimws(description |> tail(1))
    if (description == "<p></p>") {
      description <- character()
    }
  }
