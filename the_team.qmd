...
x <- dplyr::tibble(
  ndorms_id = c(
    "edward-burn", "marti-catala-sabate", "danielle-newby", "mike-du", "xihang-chen", "kim-lopez-guell",
    "marta-alcalde-herraiz",
    "nuria-mercade-besora", "elin-rowlands"),
  github = c(
    "edward-burn", "catalamarti", "daniellenewby", "ilovemane",
    "xihang-chen", "KimLopezGuell", "martaalcalde",
    "nmercadeb", "elinrow"
  ),
  email = c(
    "edarwd.burn@ndorms", "marti.catalasabate@ndorms", "danielle.newby@ndorms", 
    "mike.du@ndorms",
    "xihang.chen@ndorms", "kim.lopez@spc",
