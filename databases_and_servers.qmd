...
For CPRD database access you will need to complete additional training provided by them and register at ndorms as a user of CPRD. See [here](https://intranet.ndorms.ox.ac.uk/information-governance/big-data-at-ndorms/clinical-practice-research-datalink-cprd-1) on the intranet for more information. You will also need to create an account on [CPRD eRap](https://www.erap.cprd.com/) and then be added onto a new or existing application to be granted access to CPRD on our servers. Things to note:
