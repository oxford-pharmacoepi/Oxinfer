...
-   **Data partner** This is the term we use for a database source usually this is a person/s responsible for executing the analytical code.

-   **Federated network studies**

When the same analytical code is run across multiple databases/data partners across the UK, Europe, Globe etc in one study **Note** we only share analytical code with a data partner and they run the code.
